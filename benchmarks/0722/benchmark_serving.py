...
def main(args: argparse.Namespace):
    ...
    print(f"result, {p50_ttft:.3f}, {p99_ttft:.3f}, {p50_tpot:.3f}, {p99_tpot:.3f}, {p50_tpt:.3f}, {p99_tpt:.3f}, {throughput:.3f}, {request_per_second}, {np.mean(tpts):.3f}, {preempt_flag}")
