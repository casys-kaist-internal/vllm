...
def main(args: argparse.Namespace):
    ...
    prompt_output_csv = f'result_alibi/{directory}/prompt_output.csv'
    accept_probs_csv = f'result_alibi/{directory}/accept_probs.csv'
    beta_list_csv = f'result_alibi/{directory}/beta_list.csv'
    accept_cnt_list_csv = f'result_alibi/{directory}/accept_cnt_list.csv'
    reject_pos_csv = f'result_alibi/{directory}/reject_pos.csv'

    # Make new directory remove if already exists
    import os
    if os.path.exists(f'result_alibi/{directory}'):
        os.system(f'rm -rf result_alibi/{directory}')
    os.makedirs(f'result_alibi/{directory}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--draft-model', type=str, default='bigscience/bloomz-560m')
