...
if __name__ == "__main__":
    ...
    parser.add_argument("--query-len", type=int, default=2)  # -1 is random
    ...
    #         print("PASS query_len : ", average_query_len, " context_len : ",
    #               average_context_len, " num_seqs : ", num_seqs)
    #     except TooManyBlocks as e:
    #         print("SKIP : ", average_query_len, " context_len : ",
    #               average_context_len, " num_seqs : ", num_seqs)
    #     except Exception as e:
    #         print("Failed with query_len : ", average_query_len,
    #               " context_len : ", average_context_len, " num_seqs : ", num_seqs)
    #         print(e)
    #         break
