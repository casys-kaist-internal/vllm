...
# 입력 폴더와 출력 폴더 경로
input_folder_path = "/home/yhkim/workspace/vllm/benchmarks/result_per_layer/facebook"
output_folder_path = "/home/yhkim/workspace/vllm/benchmarks/result_per_layer_merged/facebook"

# 입력 폴더 내의 모든 CSV 파일 찾기
input_files = glob.glob(os.path.join(input_folder_path, '*.csv'))
...
for input_csv_path in input_files:
    ...
    output_csv_path = os.path.join(output_folder_path, os.path.basename(input_csv_path))
