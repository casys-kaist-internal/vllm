...
def main(args: argparse.Namespace):
    ...
    table = [["colocate", args.colocate],
             ...
             ["budget", args.budget],
             ["demote_spec_tokens", args.demote_spec_tokens],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--demote-spec-tokens",
                        '-dst',
                        action="store_true",
                        help="Deprioritize spec decode tokens over prefill tokens in chunk_prefill")
    ...
    if args.demote_spec_tokens:
        assert args.chunked_prefill
