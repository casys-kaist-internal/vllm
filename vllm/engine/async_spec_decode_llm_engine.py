...
from vllm.engine.arg_utils import AsyncSpecDecodeEngineArgs
...
class _AsyncSpecDecodeLLMEngine(SpecDecodeLLMEngine):
...
class AsyncSpecDecodeLLMEngine:
    ...
    _engine_class: Type[_AsyncSpecDecodeLLMEngine] = _AsyncSpecDecodeLLMEngine
    ...
    def _init_engine(self, *args,
                     **kwargs) -> Union[_AsyncSpecDecodeLLMEngine, "ray.ObjectRef"]:
    ...
    def from_engine_args(cls,
                         ...
                         start_engine_loop: bool = True) -> "AsyncSpecDecodeLLMEngine":
