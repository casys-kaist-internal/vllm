...
from vllm.sequence import SamplerOutput, SequenceData, SequenceGroupMetadata, SpSStage
...
class SpSModelRunner:
    ...
    def _prepare_prompt(
        ...
        for seq_group_metadata in seq_group_metadata_list:
            assert seq_group_metadata.sps_stage == SpSStage.PROMPT
    ...
    def execute_model(
        ...
        if sps_stage == SpSStage.PROMPT:
            ...
            inputs = self._prepare_draft_decode(seq_group_metadata_list)
    ...
    @torch.inference_mode()
    def profile_run(self, seqs: List[SequenceGroupMetadata]) -> None:
