...
class OPTAttention(nn.Module):
    ...
    def forward(
        ...
        end_event.record()
        torch.cuda.synchronize()
        print(f"PagedAttention, {start_event.elapsed_time(end_event)}")
...
class OPTDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if self.do_layer_norm_before:
            ...
            end_event.record()
            torch.cuda.synchronize()
            print(f"LayerNorm, {start_event.elapsed_time(end_event)}")
        ...
        end_event.record()
        torch.cuda.synchronize()
        print(f"ResidualAdd, {start_event.elapsed_time(end_event)}")
        ...
        end_event.record()
        torch.cuda.synchronize()
        print(f"Activation, {start_event.elapsed_time(end_event)}")
