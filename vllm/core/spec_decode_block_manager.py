...
class SpecDecodeBlockAllocator:
...
class SpecDecodeAllocStatus(enum.Enum):
...
class SpecDecodeBlockSpaceManager:
    ...
    def __init__(
        ...
        self.gpu_allocator = SpecDecodeBlockAllocator(Device.GPU, block_size,
                                                      num_gpu_blocks)
        self.cpu_allocator = SpecDecodeBlockAllocator(Device.CPU, block_size,
                                                      num_cpu_blocks)
        # Mapping: seq_id -> BlockTable.
        self.block_tables: Dict[int, BlockTable] = {}

    def can_allocate(self, seq_group: SequenceGroup) -> SpecDecodeAllocStatus:
        ...
        if (self.num_total_gpu_blocks - num_required_blocks <
            ...
            return SpecDecodeAllocStatus.NEVER
        if num_free_gpu_blocks - num_required_blocks >= self.watermark_blocks:
            return SpecDecodeAllocStatus.OK
        else:
            return SpecDecodeAllocStatus.LATER
    ...
    def append_slot(self, seq: Sequence) -> Optional[Tuple[int, int]]:
        ...
        if last_block.ref_count == 1:
            ...
            # For spec decode, blocks cannot be shared.
            raise ValueError(
                "The last block cannot be shared with other sequences.")
